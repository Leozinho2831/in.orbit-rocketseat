export function InOrbitIcon(){
  return (
    ...
    >
      ...
      />
      <path
        d="M23.215 15.246a12.016 12.016 0 01-8.97 8.969 7.408 7.408 0 01-3.543-1.98A7.426 7.426 0 019 19.605 7.515 7.515 0 0018.605 10c.958.362 1.857.93 2.63 1.702a7.411 7.411 0 011.98 3.544z"
